      ...
      <div style={{display: "flex", flexDirection: "column", margin: 10}}>
        <ul>
          ...
          <li>Mit React-Native hat man die Möglichkeit native Apps für iOS und Android zu entwickeln. React und
            React-Native unterscheiden sich lediglich anhand der Komponenten Tags (z.B. <code lang={'html'}>div =
              View</code>).
          </li>
          <li>Es sind zahlreiche Komponentenbibliotheken verfügbar.</li>

          <h4>Unter der Haube</h4>
          <li>Der Virtual DOM ist eine zentrale Komponente in React. Er ist eine in-memory-Repräsentation des
            tatsächlichen DOMs. Jedesmal, wenn sich der Zustand einer Komponente ändert, erstellt React einen neuen
